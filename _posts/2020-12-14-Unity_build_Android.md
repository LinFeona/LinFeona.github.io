...
![0-1](images/build/jdk_path_1-4.png "ddd")

- 那么恭喜你 这一步可以跳过了 可往下拉到sdk的环节了

- 1.安装jdk

![0-1](images/build/jdk_0-1.png "ddd")

- 选择一个路径 最好默认的路径 记住这个路径 环境变量会用到

![0-1](images/build/jdk_0-2.png"ddd")
...
![0-1](images/build/jdk_path_1-3.png "ddd")
...
![tools](images/build/jdk_path_1-4.png)
![0-1](images/build/unity_build_0-9.png "ddd")

-  External Tools -> sdk 将勾选取消掉 点击  `Browse` 选择sdk的路径

![0-1](images/build/unity_build_0-8.png "ddd")
...
![0-1](images/build/unity_build_0-10.png "ddd")


- 打开 `Player Settings` 进行打包设置

![0-1](images/build/unity_build_0-4.png "ddd")

- 注意看包名格式 xxx.xxx.xxx 公司名.包名.游戏名

![0-1](images/build/unity_build_0-3.png "ddd")

- 最后 开始打包 build 

![0-1](images/build/unity_build_0-6.png "ddd")
